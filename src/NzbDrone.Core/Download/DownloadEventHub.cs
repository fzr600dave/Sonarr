...
namespace NzbDrone.Core.Download
{
    ...
    public class DownloadEventHub : IHandle<DownloadCompletedEvent>, IHandle<DownloadFailedEvent>
    {
        ...
        {
            if (message.TrackedDownload.DownloadItem.IsReadOnly || !_configService.RemoveCompletedDownloads)
            {
                return;
            }
